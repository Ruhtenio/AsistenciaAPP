...
/* harmony import */ var _button_active_9f97b694_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./button-active-9f97b694.js */ 5652);
/* harmony import */ var _overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-6ab11907.js */ 6419);
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.B);
    };

    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;

      if ((0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.i)(role)) {
  ...
  present() {
    return (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
  }

  connectedCallback() {
    (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.el);
  }
  /**
  ...
  dismiss(data, role) {
    return (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
  ...
  onDidDismiss() {
    return (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetWillDismiss');
  }
  ...
  callButtonHandler(button) {
    return (0,_home_alumno_Descargas_proyecto2control3_proyecto2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_6ab11907_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler);
  ...
  componentDidLoad() {
    ...
    (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.f)(() => {
      ...
      if (!isScrollable) {
        this.gesture = (0,_button_active_9f97b694_js__WEBPACK_IMPORTED_MODULE_3__.c)(wrapperEl, refEl => refEl.classList.contains('action-sheet-button'));
